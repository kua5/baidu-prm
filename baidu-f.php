...
if (preg_match_all("/(?<=\" tpl\=\")([0-9a-z_]{3,28})(?=\")/", $baiduserp, $matchtypelink))
...
<div class=\"draglist\" draggable=\"true\">
	...
	foreach ($matchtypelink[1] as $i => $position)
	{
		$typelink = $matchtypelink[1][$i];
		echo "
			<tr class=\"back-sky\">";
		{
		if ($typelink == "zx_zhidaokv")
			echo "
				<td>
					知心_百度知道关键词展现
				</td>";
		elseif ($typelink == "zx_tv_video")
			echo "
				<td>
					知心_电视剧_百度视频
				</td>";
		elseif ($typelink == "zx_tuan_cinema")
			echo "
				<td>
					知心_百度团购_影片
				</td>";
		elseif ($typelink == "zx_tour_map_v2")
			echo "
				<td>
					知心_百度旅游_地图_第&nbsp;2&nbsp;版
				</td>";
		elseif ($typelink == "zx_tour_intro_v2")
			echo "
				<td>
					知心_百度旅游_介绍_第&nbsp;2&nbsp;版
				</td>";
		elseif ($typelink == "zx_tour_intro")
			echo "
				<td>
					知心_百度旅游_介绍
				</td>";
		elseif ($typelink == "zx_mussong")
			echo "
				<td>
					知心_百度音乐
				</td>";
		elseif ($typelink == "zx_meddeptdoc")
			echo "
				<td>
					知心_医院科室文档
				</td>";
		elseif ($typelink == "zx_medbaike")
			echo "
				<td>
					知心_百度医疗百科
				</td>";
		elseif ($typelink == "zx_illness2")
			echo "
				<td>
					知心_第&nbsp;2&nbsp;种疾病
				</td>";
		elseif ($typelink == "zx_hospwebsite")
			echo "
				<td>
					知心_医院网站
				</td>";
		elseif ($typelink == "zx_hospolregbj")
			echo "
				<td>
					知心_医院在线挂号北京
				</td>";
		elseif ($typelink == "zx_hospolreg")
			echo "
				<td>
					知心_医院在线挂号
				</td>";
		elseif ($typelink == "zx_hospdept")
			echo "
				<td>
					知心_医院科室
				</td>";
		elseif ($typelink == "zx_eduexam")
			echo "
				<td>
					知心_教育考试
				</td>";
		elseif ($typelink == "zx_cinema")
			echo "
				<td>
					知心_影片
				</td>";
		elseif ($typelink == "zhidao_lawyer")
			echo "
				<td>
					百度知道_律师
				</td>";
		elseif ($typelink == "zhidao")
			echo "
				<td>
					百度知道
				</td>";
		elseif ($typelink == "zhaopinhui")
			echo "
				<td>
					招聘会
				</td>";
		elseif ($typelink == "zhaopin")
			echo "
				<td>
					百度招聘
				</td>";
		elseif ($typelink == "worldtime")
			echo "
				<td>
					世界时间
				</td>";
		elseif ($typelink == "worldcup_table")
			echo "
				<td>
					世界杯&nbsp;表格
				</td>";
		elseif ($typelink == "worldcup_news")
			echo "
				<td>
					世界杯&nbsp;新闻
				</td>";
		elseif ($typelink == "worldcup1")
			echo "
				<td>
					第&nbsp;1&nbsp;种世界杯
				</td>";
		elseif ($typelink == "wenku_org")
			echo "
				<td>
					百度文库_认证机构
				</td>";
		elseif ($typelink == "weather4_twoico_simple")
			echo "
				<td>
					左侧天气预报4_2个图标_简单
				</td>";
		elseif ($typelink == "weather4_twoicon")
			echo "
				<td>
					左侧天气预报4_2个图标
				</td>";
		elseif ($typelink == "view_pic")
			echo "
				<td>
					展现_图片
				</td>";
		elseif ($typelink == "viewpoints_multi")
			echo "
				<td>
					展现观点_多样化
				</td>";
		elseif ($typelink == "videoidea")
			echo "
				<td>
					视频印象
				</td>";
		elseif ($typelink == "video_kv")
			echo "
				<td>
					百度视频_关键词展现
				</td>";
		elseif ($typelink == "vd_mininewest")
			echo "
				<td>
					百度视频_迷你最新
				</td>";
		elseif ($typelink == "vd_tamasha")
			echo "
				<td>
					百度视频_娱乐节目
				</td>";
		elseif ($typelink == "vd_sitcom")
			echo "
				<td>
					百度视频_情景喜剧
				</td>";
		elseif ($typelink == "vd_comic")
			echo "
				<td>
					百度视频_动漫
				</td>";
		elseif ($typelink == "vd_baidu")
			echo "
				<td>
					百度视频
				</td>";
		elseif ($typelink == "url3")
			echo "
				<td>
					[猜]&nbsp;电子书
				</td>";
		...
		elseif ($typelink == "university")
			echo "
				<td>
					大学
				</td>";
		elseif ($typelink == "unit")
			echo "
				<td>
					单位
				</td>";
		elseif ($typelink == "tvplay")
			echo "
				<td>
					电视播放
				</td>";
		elseif ($typelink == "tv05")
			echo "
				<td>
					电视05
				</td>";
		elseif ($typelink == "tuangou")
			echo "
				<td>
					百度团购
				</td>";
		elseif ($typelink == "trust")
			echo "
				<td>
					信用
				</td>";
		elseif ($typelink == "travel")
			echo "
				<td>
					旅游
				</td>";
		elseif ($typelink == "traintimetable05")
			echo "
				<td>
					第&nbsp;5&nbsp;种列车时刻表
				</td>";
		elseif ($typelink == "traintimetable04")
			echo "
				<td>
					第&nbsp;4&nbsp;种列车时刻表
				</td>";
		elseif ($typelink == "traintimetable03")
			echo "
				<td>
					第&nbsp;3&nbsp;种列车时刻表
				</td>";
		elseif ($typelink == "translation")
			echo "
				<td>
					翻译
				</td>";
		elseif ($typelink == "tour_spot")
			echo "
				<td>
					旅游_圆点
				</td>";
		elseif ($typelink == "tour_aim")
			echo "
				<td>
					旅游_目的地
				</td>";
		elseif ($typelink == "ting_album")
			echo "
				<td>
					听_专辑
				</td>";
		elseif ($typelink == "timeliness_news2")
			echo "
				<td>
					时间轴_第&nbsp;2&nbsp;种新闻
				</td>";
		elseif ($typelink == "timeliness_news")
			echo "
				<td>
					时间轴_新闻
				</td>";
		elseif ($typelink == "tieba_star")
			echo "
				<td>
					百度贴吧_明星
				</td>";
		elseif ($typelink == "tieba_novel")
			echo "
				<td>
					百度贴吧_小说
				</td>";
		elseif ($typelink == "tieba_live")
			echo "
				<td>
					百度贴吧_直播
				</td>";
		elseif ($typelink == "tieba2")
			echo "
				<td>
					第&nbsp;2&nbsp;种百度贴吧
				</td>";
		elseif ($typelink == "tieba")
			echo "
				<td>
					贴吧
				</td>";
		elseif ($typelink == "tieba_offical")
			echo "
				<td>
					百度贴吧_官方
				</td>";
		elseif ($typelink == "tieba_kv2")
			echo "
				<td>
					百度贴吧_第&nbsp;2&nbsp;种关键词展现
				</td>";
		elseif ($typelink == "tieba_kv")
			echo "
				<td>
					百度贴吧_关键词展现
				</td>";
		elseif ($typelink == "text04")
			echo "
				<td>
					文本&nbsp;04
				</td>";
		elseif ($typelink == "text02")
			echo "
				<td>
					文本&nbsp;02
				</td>";
		elseif ($typelink == "text01")
			echo "
				<td>
					文本&nbsp;01
				</td>";
		elseif ($typelink == "table09")
			echo "
				<td>
					表格&nbsp;09
				</td>";
		elseif ($typelink == "table08new")
			echo "
				<td>
					表格&nbsp;08&nbsp;新
				</td>";
		elseif ($typelink == "table05")
			echo "
				<td>
					表格&nbsp;05
				</td>";
		elseif ($typelink == "table03")
			echo "
				<td>
					表格&nbsp;03
				</td>";
		elseif ($typelink == "table02")
			echo "
				<td>
					表格&nbsp;02
				</td>";
		elseif ($typelink == "table01")
			echo "
				<td>
					表格&nbsp;01
				</td>";
		elseif ($typelink == "superson_ipush")
			echo "
				<td>
					[猜]&nbsp;超级子链_ipush
				</td>";
		elseif ($typelink == "stockdynamic")
			echo "
				<td>
					股票实时行情
				</td>";
		elseif ($typelink == "staralbum")
			echo "
				<td>
					明星相册
				</td>";
		elseif ($typelink == "sport_game")
			echo "
				<td>
					体育_游戏
				</td>";
		elseif ($typelink == "sp_weibo")
			echo "
				<td>
					百度搜索产品_最新微博结果
				</td>";
		elseif ($typelink == "sp_realtime")
			echo "
				<td>
					百度搜索产品_最新相关信息
				</td>";
		elseif ($typelink == "sp_img")
			echo "
				<td>
					百度搜索产品_图片
				</td>";
		elseif ($typelink == "sp_fanyi")
			echo "
				<td>
					百度搜索产品_翻译
				</td>";
		elseif ($typelink == "sohugeneral")
			echo "
				<td>
					搜狐通用结果
				</td>";
		elseif ($typelink == "sohu")
			echo "
				<td>
					搜狐
				</td>";
		elseif ($typelink == "softdown")
			echo "
				<td>
					软件下载
				</td>";
		elseif ($typelink == "soft")
			echo "
				<td>
					软件
				</td>";
		elseif ($typelink == "singer")
			echo "
				<td>
					歌手
				</td>";
		elseif ($typelink == "singlevideo")
			echo "
				<td>
					单视频
				</td>";
		elseif ($typelink == "site")
			echo "
				<td>
					站点(站点信息)
				</td>";
		elseif ($typelink == "shares_simple")
			echo "
				<td>
					股票_简单
				</td>";
		elseif ($typelink == "se_st_single_video_zhanzhang")
			echo "
				<td>
					搜索引擎_结构化数据_单一_视频_站长
				</td>";
		elseif ($typelink == "se_st_robots")
			echo "
				<td>
					搜索引擎_结构化数据_限制
				</td>";
		elseif ($typelink == "se_st_image_baike")
			echo "
				<td>
					搜索引擎_结构化数据_图像_百度百科
				</td>";
		elseif ($typelink == "se_st_guanwang")
			echo "
				<td>
					搜索引擎_结构化数据_官网
				</td>";
		elseif ($typelink == "se_st_gallery")
			echo "
				<td>
					搜索引擎_结构化数据_相册
				</td>";
		elseif ($typelink == "se_st_default")
			echo "
				<td>
					搜索引擎_结构化数据_默认
				</td>";
		elseif ($typelink == "se_st_com_abstract")
			echo "
				<td>
					搜索引擎_结构化数据_网站_摘要
				</td>";
		elseif ($typelink == "se_st_cinecism")
			echo "
				<td>
					搜索引擎_结构化数据_影评
				</td>";
		elseif ($typelink == "se_st_baike")
			echo "
				<td>
					搜索引擎_结构化数据_百度百科
				</td>";
		elseif ($typelink == "seriesmovie")
			echo "
				<td>
					同系列电影
				</td>";
		elseif ($typelink == "se_com_structure_img")
			echo "
				<td>
					搜索引擎_网站_结构化数据_图片
				</td>";
		elseif ($typelink == "se_com_default")
			echo "
				<td>
					搜索引擎_网站_默认
				</td>";
		elseif ($typelink == "se_as_zhidaoaladdin")
			echo "
				<td>
					搜索引擎_[猜]&nbsp;普通搜索结果_百度知道阿拉丁
				</td>";
		elseif ($typelink == "se_as_default")
			echo "
				<td>
					搜索引擎_[猜]&nbsp;普通搜索结果_默认
				</td>";
		elseif ($typelink == "sam_weibo")
			echo "
				<td>
					[猜]&nbsp;保密算法md5_微博
				</td>";
		elseif ($typelink == "sam_showurl_renzheng")
			echo "
				<td>
					[猜]&nbsp;保密算法md5_展现网址_认证
				</td>";
		elseif ($typelink == "sam_showurl_fanyi")
			echo "
				<td>
					[猜]&nbsp;保密算法md5_展现网址_反义
				</td>";
		elseif ($typelink == "right_worldcup_countdown")
			echo "
				<td class=\"back-gold\">
					右侧_世界杯_倒计时
				</td>";
		elseif ($typelink == "right_toplist")
			echo "
				<td class=\"back-gold\">
					右侧_百度风云榜
				</td>";
		elseif ($typelink == "right_topic")
			echo "
				<td class=\"back-gold\">
					右侧_专题
				</td>";
		elseif ($typelink == "right_timeliness")
			echo "
				<td class=\"back-gold\">
					右侧_时效性结果
				</td>";
		elseif ($typelink == "right_timeline_blue")
			echo "
				<td class=\"back-gold\">
					右侧_时间轴_事件脉络
				</td>";
		elseif ($typelink == "right_tabs")
			echo "
				<td class=\"back-gold\">
					[猜]&nbsp;右侧_标签(深度合作)
				</td>";
		elseif ($typelink == "right_singlepoint_hot")
			echo "
				<td class=\"back-gold\">
					[猜]&nbsp;右侧_单坐标_热门
				</td>";
		elseif ($typelink == "right_shijiebei_ci")
			echo "
				<td class=\"back-gold\">
					右侧_世界杯_谈资
				</td>";
		elseif ($typelink == "right_result")
			echo "
				<td class=\"back-gold\">
					右侧_结果
				</td>";
		elseif ($typelink == "right_relatable")
			echo "
				<td class=\"back-gold\">
					右侧_相关表格
				</td>";
		elseif ($typelink == "right_relaperson")
			echo "
				<td class=\"back-gold\">
					右侧_知心相关结果
				</td>";
		elseif ($typelink == "right_recommends")
			echo "
				<td class=\"back-gold\">
					右侧_推荐
				</td>";
		elseif ($typelink == "right_qunar_dujia")
			echo "
				<td class=\"back-gold\">
					右侧_去哪儿_度假
				</td>";
		elseif ($typelink == "right_pregnancyv")
			echo "
				<td class=\"back-gold\">
					右侧_妊娠|考试
				</td>";
		elseif ($typelink == "right_personinfo")
			echo "
				<td class=\"back-gold\">
					右侧_生活信息
				</td>";
		elseif ($typelink == "right_offical")
			echo "
				<td class=\"back-gold\">
					右侧_官方信息
				</td>";
		elseif ($typelink == "right_novel")
			echo "
				<td class=\"back-gold\">
					右侧_小说
				</td>";
		elseif ($typelink == "right_newaction")
			echo "
				<td class=\"back-gold\">
					右侧_新动作
				</td>";
		elseif ($typelink == "right_nba")
			echo "
				<td class=\"back-gold\">
					右侧_NBA
				</td>";
		elseif ($typelink == "right_musichot")
			echo "
				<td class=\"back-gold\">
					右侧_热门歌曲
				</td>";
		elseif ($typelink == "right_medreladept")
			echo "
				<td class=\"back-gold\">
					右侧_医疗相关科室
				</td>";
		elseif ($typelink == "right_links")
			echo "
				<td class=\"back-gold\">
					右侧_链接(工具导航)
				</td>";
		elseif ($typelink == "right_law")
			echo "
				<td class=\"back-gold\">
					右侧_法律
				</td>";
		elseif ($typelink == "right_jigou_danpoi")
			echo "
				<td class=\"back-gold\">
					右侧_机构_单点地图信息
				</td>";
		elseif ($typelink == "right_hotlist")
			echo "
				<td class=\"back-gold\">
					右侧_热门列表
				</td>";
		elseif ($typelink == "right_favorvideo")
			echo "
				<td class=\"back-gold\">
					右侧_喜欢的视频
				</td>";
		elseif ($typelink == "right_examtimeline")
			echo "
				<td class=\"back-gold\">
					右侧_考试时间线
				</td>";
		elseif ($typelink == "right_entity")
			echo "
				<td class=\"back-gold\">
					右侧_实体
				</td>";
		elseif ($typelink == "right_commontable")
			echo "
				<td class=\"back-gold\">
					右侧_普通表格
				</td>";
		elseif ($typelink == "right_chunjie2013")
			echo "
				<td class=\"back-gold\">
					右侧_2013春节
				</td>";
		elseif ($typelink == "right_bless")
			echo "
				<td class=\"back-gold\">
					右侧_祈福
				</td>";
		elseif ($typelink == "right_birthday")
			echo "
				<td class=\"back-gold\">
					右侧_生日
				</td>";
		elseif ($typelink == "right_article")
			echo "
				<td class=\"back-gold\">
					右侧_文章(站长资讯)
				</td>";
		elseif ($typelink == "renrenname")
			echo "
				<td>
					人人网同名搜索
				</td>";
		elseif ($typelink == "realtime_kv")
			echo "
				<td>
					最新相关消息_关键词展现
				</td>";
		elseif ($typelink == "realtime_image")
			echo "
				<td>
					最新图片
				</td>";
		elseif ($typelink == "realtimetraffic")
			echo "
				<td>
					实时路况
				</td>";
		elseif ($typelink == "qunar_menpiao02")
			echo "
				<td>
					去哪儿_第&nbsp;3&nbsp;种门票
				</td>";
		elseif ($typelink == "qunar_flight03")
			echo "
				<td>
					去哪儿_第&nbsp;3&nbsp;种机票
				</td>";
		elseif ($typelink == "qunar_dujia06")
			echo "
				<td>
					去哪儿_第&nbsp;6&nbsp;种度假
				</td>";
		elseif ($typelink == "qunar_dujia05")
			echo "
				<td>
					去哪儿_第&nbsp;5&nbsp;种度假
				</td>";
		elseif ($typelink == "qunar_dujia03")
			echo "
				<td>
					去哪儿_第&nbsp;3&nbsp;种度假
				</td>";
		elseif ($typelink == "qunar_dujia01")
			echo "
				<td>
					去哪儿_第&nbsp;1&nbsp;种度假
				</td>";
		elseif ($typelink == "qidian2")
			echo "
				<td>
					第&nbsp;2&nbsp;种起点结果
				</td>";
		elseif ($typelink == "qidian")
			echo "
				<td>
					起点结果
				</td>";
		elseif ($typelink == "pic01")
			echo "
				<td>
					第&nbsp;1&nbsp;种图片
				</td>";
		elseif ($typelink == "piao")
			echo "
				<td>
					百度票务
				</td>";
		elseif ($typelink == "pcsoft")
			echo "
				<td>
					电脑软件
				</td>";
		elseif ($typelink == "offical_weibo")
			echo "
				<td>
					官方_微博
				</td>";
		elseif ($typelink == "normalresult02")
			echo "
				<td>
					正常结果&nbsp;02
				</td>";
		elseif ($typelink == "normal_link")
			echo "
				<td>
					正常_链接
				</td>";
		elseif ($typelink == "newtv0502")
			echo "
				<td>
					新电视&nbsp;05&nbsp;02
				</td>";
		elseif ($typelink == "newflight")
			echo "
				<td>
					新航班
				</td>";
		elseif ($typelink == "nbaseason")
			echo "
				<td>
					NBA赛季
				</td>";
		elseif ($typelink == "naturalresult")
			echo "
				<td>
					自然结果
				</td>";
		elseif ($typelink == "music_kv")
			echo "
				<td>
					百度音乐_关键词展现
				</td>";
		elseif ($typelink == "movievideo")
			echo "
				<td>
					电影视频
				</td>";
		elseif ($typelink == "mobilephone")
			echo "
				<td>
					移动电话
				</td>";
		elseif ($typelink == "minisearch")
			echo "
				<td>
					百度购物搜索迷你搜索
				</td>";
		elseif ($typelink == "matchresult")
			echo "
				<td>
					一般比赛
				</td>";
		elseif ($typelink == "matchgeneral")
			echo "
				<td>
					一般比赛
				</td>";
		elseif ($typelink == "map_subway")
			echo "
				<td>
					百度地图_地铁
				</td>";
		elseif ($typelink == "map_singlepoint")
			echo "
				<td>
					百度地图_单地点
				</td>";
		elseif ($typelink == "mapdots")
			echo "
				<td>
					百度地图圆点
				</td>";
		elseif ($typelink == "mapcity")
			echo "
				<td>
					百度地图城市
				</td>";
		elseif ($typelink == "map_city")
			echo "
				<td>
					百度地图_城市|省份
				</td>";
		elseif ($typelink == "macao_permit")
			echo "
				<td>
					[猜]&nbsp;马槽_许可证
				</td>";
		elseif ($typelink == "liarphone2")
			echo "
				<td>
					第&nbsp;2&nbsp;种骚扰电话
				</td>";
		elseif ($typelink == "koubei")
			echo "
				<td>
					百度口碑
				</td>";
		elseif ($typelink == "kefu3")
			echo "
				<td>
					第&nbsp;3&nbsp;种客服电话
				</td>";
		elseif ($typelink == "kefu2")
			echo "
				<td>
					第&nbsp;2&nbsp;种客服电话
				</td>";
		elseif ($typelink == "kefu_table")
			echo "
				<td>
					客服电话_表
				</td>";
		elseif ($typelink == "kefu")
			echo "
				<td>
					客服电话
				</td>";
		elseif ($typelink == "jingyan_summary")
			echo "
				<td>
					百度经验_组图
				</td>";
		elseif ($typelink == "img_star")
			echo "
				<td>
					百度图片_明星
				</td>";
		elseif ($typelink == "img_spot")
			echo "
				<td>
					百度图片_景点
				</td>";
		elseif ($typelink == "img_dress")
			echo "
				<td>
					百度图片_裙子
				</td>";
		elseif ($typelink == "img_car")
			echo "
				<td>
					百度图片_汽车
				</td>";
		elseif ($typelink == "image_kv")
			echo "
				<td>
					百度图片_关键词展现
				</td>";
		elseif ($typelink == "hotmovie")
			echo "
				<td>
					热映电影
				</td>";
		elseif ($typelink == "hospital")
			echo "
				<td>
					医院
				</td>";
		elseif ($typelink == "hao123_table")
			echo "
				<td>
					hao123网址之家_表格
				</td>";
		elseif ($typelink == "guahao")
			echo "
				<td>
					挂号
				</td>";
		elseif ($typelink == "generalqa")
			echo "
				<td>
					一般问答
				</td>";
		elseif ($typelink == "gamegear2")
			echo "
				<td>
					第&nbsp;2&nbsp;种游戏齿轮
				</td>";
		elseif ($typelink == "game01")
			echo "
				<td>
					第&nbsp;1&nbsp;种游戏
				</td>";
		elseif ($typelink == "fontconversion04")
			echo "
				<td>
					字体转换04
				</td>";
		elseif ($typelink == "flight2")
			echo "
				<td>
					飞机2
				</td>";
		elseif ($typelink == "exrate")
			echo "
				<td>
					汇率
				</td>";
		elseif ($typelink == "express_delivery")
			echo "
				<td>
					捷运_快递
				</td>";
		elseif ($typelink == "exactqa_spp")
			echo "
				<td>
					精准问答_搜索产品页
				</td>";
		elseif ($typelink == "exactqa")
			echo "
				<td>
					精准问答
				</td>";
		elseif ($typelink == "entity_clusters")
			echo "
				<td>
					实例&nbsp;团体
				</td>";
		elseif ($typelink == "email3")
			echo "
				<td>
					第&nbsp;3&nbsp;种电子邮件
				</td>";
		elseif ($typelink == "ecr_web_game_platform")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_网页_游戏_平台
				</td>";
		elseif ($typelink == "ecr_web_game_gn_servers_biz")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_网页_游戏_一般_服务器_商业
				</td>";
		elseif ($typelink == "ecr_web_game_gn_gift2")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_网页_游戏_一般_第&nbsp;2&nbsp;种礼包
				</td>";
		elseif ($typelink == "ecr_wealth_small")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_财富_小
				</td>";
		elseif ($typelink == "ecr_temai_recommend_lst_exp2")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_百度特卖_列表_第&nbsp;2&nbsp;种展示
				</td>";
		elseif ($typelink == "ecr_pc_game_recommend")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_电脑_游戏_推荐
				</td>";
		elseif ($typelink == "ecr_pc_game_gn_top_game")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_电脑_游戏_一般_热门_游戏
				</td>";
		elseif ($typelink == "ecr_pc_game_gn_servers")
			echo "
				<td class=\"back-gold\">
					百度知心商业体系右侧_电脑_游戏_一般_服务器
				</td>";
		elseif ($typelink == "ecl_web_game_platform")
			echo "
				<td>
					百度知心商业体系左侧_网页_游戏_平台
				</td>";
		elseif ($typelink == "ecl_wealth_list")
			echo "
				<td>
					百度知心商业体系左侧_百度财富_列表
				</td>";
		elseif ($typelink == "ecl_tour")
			echo "
				<td>
					百度知心商业体系左侧_百度旅游_
				</td>";
		elseif ($typelink == "ecl_tg_weigou_brandsale_exp2")
			echo "
				<td>
					百度知心商业体系左侧_百度团购_百度微购_品牌特卖_第 2 种表达
				</td>";
		elseif ($typelink == "ecl_tg_weigou_brandsale_exp")
			echo "
				<td>
					百度知心商业体系左侧_百度团购_百度微购_品牌特卖_表达
				</td>";
		elseif ($typelink == "ecl_tg_home_grid")
			echo "
				<td>
					百度知心商业体系左侧_百度团购_主页_格子
				</td>";
		elseif ($typelink == "ecl_pc_game_platform")
			echo "
				<td>
					百度知心左侧_电脑_游戏_平台
				</td>";
		elseif ($typelink == "ecl_pc_game_general_games")
			echo "
				<td>
					百度知心商业体系左侧_电脑_游戏_一般_游戏
				</td>";
		elseif ($typelink == "ecl_med_mix")
			echo "
				<td>
					百度知心商业体系左侧_药物_混合
				</td>";
		elseif ($typelink == "ecl_health_women")
			echo "
				<td>
					百度知心商业体系左侧_健康_女性
				</td>";
		elseif ($typelink == "ecl_health_operation_pic")
			echo "
				<td>
					百度知心商业体系左侧_健康_手术_图片
				</td>";
		elseif ($typelink == "ecl_health_mix_page")
			echo "
				<td>
					百度知心商业体系左侧_健康_混合_页面
				</td>";
		elseif ($typelink == "ecl_health_mix")
			echo "
				<td>
					百度知心商业体系左侧_健康_混合
				</td>";
		elseif ($typelink == "ecl_health_knowledge_pic")
			echo "
				<td>
					百度知心商业体系左侧_健康_知识_图片
				</td>";
		elseif ($typelink == "ecl_game_zone")
			echo "
				<td>
					百度知心商业体系左侧_游戏_专区
				</td>";
		elseif ($typelink == "ecl_game_start")
			echo "
				<td>
					百度知心商业体系左侧_游戏_开始
				</td>";
		elseif ($typelink == "ecl_game_download")
			echo "
				<td>
					百度知心商业体系左侧_游戏_下载
				</td>";
		elseif ($typelink == "ecl_edu_examine")
			echo "
				<td>
					百度知心商业体系左侧_教育_考试
				</td>";
		elseif ($typelink == "ecl_edu_course_test")
			echo "
				<td>
					百度知心商业体系左侧_教育_课程_测试
				</td>";
		elseif ($typelink == "ecl_edu_course_mini")
			echo "
				<td>
					百度知心商业体系左侧_教育_课程_迷你
				</td>";
		elseif ($typelink == "ecl_edu_abroad_image")
			echo "
				<td>
					百度知心商业体系左侧_教育_留学_图片
				</td>";
		elseif ($typelink == "ecl_ec_weigou_b")
			echo "
				<td>
					百度知心商业体系左侧_电子_百度微购_报价、参数、评论
				</td>";
		elseif ($typelink == "ecl_ec_weigou")
			echo "
				<td>
					百度知心商业体系左侧_电子_百度微购
				</td>";
		elseif ($typelink == "ecl_ec_spu_type")
			echo "
				<td>
					百度知心商业体系左侧_电子_标准化产品单位_型号
				</td>";
		elseif ($typelink == "ecl_ec_spu_series")
			echo "
				<td>
					百度知心商业体系左侧_电子_标准化产品单位_系列
				</td>";
		elseif ($typelink == "ecl_ec_single_sku")
			echo "
				<td>
					百度知心商业体系左侧_电子_单一_标准化产品单位
				</td>";
		elseif ($typelink == "ecl_ec_book_list")
			echo "
				<td>
					百度知心商业体系左侧_电子_书籍_列表
				</td>";
		elseif ($typelink == "ecl_edu_orgname")
			echo "
				<td>
					百度知心商业体系左侧_教育_机构名称
				</td>";
		elseif ($typelink == "ecl_edu_abroad_info")
			echo "
				<td>
					百度知心商业体系左侧_教育_海外_信息
				</td>";
		elseif ($typelink == "digital_series")
			echo "
				<td>
					数码_系列
				</td>";
		elseif ($typelink == "digital_comment")
			echo "
				<td>
					数码_点评
				</td>";
		elseif ($typelink == "digital_base_jgh")
			echo "
				<td>
					数码_基础_结构化
				</td>";
		elseif ($typelink == "dict3")
			echo "
				<td>
					第&nbsp;3&nbsp;种百度翻译
				</td>";
		elseif ($typelink == "dianqidaogou01")
			echo "
				<td>
					中关村在线电器导购 01
				</td>";
		elseif ($typelink == "definitive_answer_po")
			echo "
				<td>
					确定_答案_po
				</td>";
		elseif ($typelink == "credit")
			echo "
				<td>
					贷款
				</td>";
		elseif ($typelink == "cj_general")
			echo "
				<td>
					[猜]&nbsp;采集_一般
				</td>";
		elseif ($typelink == "china_voice")
			echo "
				<td>
					中国好声音
				</td>";
		elseif ($typelink == "chinavoice_step")
			echo "
				<td>
					中国好声音_比赛进程
				</td>";
		elseif ($typelink == "charitytelephone")
			echo "
				<td>
					慈善电话
				</td>";
		elseif ($typelink == "charity")
			echo "
				<td>
					慈善
				</td>";
		elseif ($typelink == "cee2")
			echo "
				<td>
					第&nbsp;2&nbsp;种全国普通高等学校招生统一考试
				</td>";
		elseif ($typelink == "cee1")
			echo "
				<td>
					第&nbsp;1&nbsp;种全国普通高等学校招生统一考试
				</td>";
		elseif ($typelink == "cartoon")
			echo "
				<td>
					卡通
				</td>";
		elseif ($typelink == "car_mini")
			echo "
				<td>
					汽车_迷你
				</td>";
		elseif ($typelink == "car1")
			echo "
				<td>
					第&nbsp;1&nbsp;种汽车
				</td>";
		elseif ($typelink == "calendar_new")
			echo "
				<td>
					日历_新
				</td>";
		elseif ($typelink == "calculator")
			echo "
				<td>
					计算器
				</td>";
		elseif ($typelink == "caiputest1")
			echo "
				<td>
					第&nbsp;1&nbsp;种菜谱测试
				</td>";
		elseif ($typelink == "caipiao")
			echo "
				<td>
					彩票
				</td>";
		elseif ($typelink == "best_answer")
			echo "
				<td>
					最佳_答案
				</td>";
		elseif ($typelink == "bk_polysemy")
			echo "
				<td>
					百度百科_多义词
				</td>";
		elseif ($typelink == "baikespecial")
			echo "
				<td>
					百度百科专有名词
				</td>";
		elseif ($typelink == "baikeperson")
			echo "
				<td>
					百度百科
				</td>";
		elseif ($typelink == "baike_kv")
			echo "
				<td>
					百度百科_关键词展现
				</td>";
		elseif ($typelink == "baby_general")
			echo "
				<td>
					育儿_一般
				</td>";
		elseif ($typelink == "baby_examine")
			echo "
				<td>
					育儿_检测
				</td>";
		...
		elseif ($typelink == "answer4")
			echo "
				<td>
					回答&nbsp;4
				</td>";
		elseif ($typelink == "ag_live04")
			echo "
				<td>
					[猜]&nbsp;话题_第&nbsp;4&nbsp;种直播
				</td>";
		elseif ($typelink == "5pics")
			echo "
				<td>
					5&nbsp;张图片
				</td>";
